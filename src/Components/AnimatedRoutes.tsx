...
import Menu from "/src/assets/shared/mobile/menu.svg";
...
function AnimatedRoutes() {
  ...
  return (
    <div>
      <div></div>
      <div className="desktop:px-[165px] desktop:py-[28px] tablet:flex tablet:items-center tablet:pt-[16px] tablet:pb-[16px] tablet:pr-[40px] tablet:pl-[39px] flex justify-between pt-[28px] pb-[28px] pr-[24px] pl-[24px]">
        <Link to="/">
          <img
            onClick={() => setOpen(false)}
            className="cursor-pointer tablet:mr-[25px]"
            src={Logo}
            alt="logo"
          />
        </Link>
        ...
        <div className="hidden tablet:flex tablet:items-center">
          <div className="desktop:mr-[264px] neededSize:mr-[50px] mr-[15px] text-[12px] leading-[15.62px] tracking-[2px] text-black font-[700] text-center flex gap-[37px]">
            <Link to="/Stories">
              <h1 className="hover:opacity-[30%] cursor-pointer">STORIES</h1>
            </Link>
            <Link to="/FEATURES">
              <h1 className="hover:opacity-[30%] cursor-pointer">FEATURES</h1>
            </Link>
            <Link to="/PRICING">
              <h1 className="hover:opacity-[30%] cursor-pointer">PRICING</h1>
            </Link>
          </div>
          <button className="tablet:leading-[15.62px] tablet:tracking-[2px] tablet:pt-[12px] tablet:pb-[12px] tablet:pr-[24px] tablet:pl-[24px] transition-all transition-duration: 0.2s hover:text-black hover:bg-neutral-200 ml-[2px] mr-[2px] max-w-[100%] pt-[14px] pb-[14px] pr-[69px] pl-[68px] bg-black text-[15px] leading-[19.53px] tracking-[2.5px] text-white font-[700]">
            GET AN INVITE
          </button>
        </div>
      </div>
      <div>
        {open ? (
          <div className="flex justify-center flex-col items-center absolute bg-white w-[100%] pt-[32px] pb-[32px]">
            <div className="text-[15px] leading-[19.53px] tracking-[2.5px] text-black font-[700] text-center flex flex-col gap-[20px] mb-[20px]">
              <Link to="/Stories">
                <h1
                  onClick={() => setOpen(!open)}
            ...
            <span className="mb-[20px] flex w-[90%] h-[1px] bg-black opacity-[25%]"></span>
      ...
      <div className="desktop:pl-[171px] desktop:pr-[165px] desktop:py-[64px] tablet:flex tablet:flex-row tablet:justify-between tablet:py-[64px] tablet:pr-[40px] tablet:pl-[39px] flex flex-col items-center bg-black pt-[56px] pb-[56px] pr-[2px] pl-[2px]">
        <div className="tablet:flex tablet:flex-col tablet:items-center">
          <svg
            className="desktop:translate-x-0 desktop:mb-0 tablet:translate-x-[-52px] mb-[32px]"
          ...
          <div className="desktop:translate-x-[-8px] desktop:translate-y-[116px] tablet:mb-0 tablet:translate-x-[-58px] tablet:translate-y-[87px] flex gap-[13px] mb-[50px]">
            {hover !== 1 ? (
              <svg
                onMouseEnter={() => {
                  setHover(1);
              ...
              >
                <defs>
                  <linearGradient id="1" x1="100%" x2="0%" y1="0%" y2="100%">
            ...
            {hover !== 2 ? (
              ...
              >
                <defs>
                  <linearGradient id="2" x1="0%" x2="100%" y1="100%" y2="0%">
            ...
            {hover !== 4 ? (
              ...
              >
                <defs>
                  <linearGradient id="4" x1="100%" x2="0%" y1="0%" y2="100%">
            ...
            {hover !== 5 ? (
              ...
              >
                <defs>
                  <linearGradient id="5" x1="0%" x2="50%" y1="100%" y2="0%">
                    <stop offset="0%" stopColor="#FFC593" />
                    <stop offset="51.945%" stopColor="#BC7198" />
                    <stop offset="100%" stopColor="#5A77FF" />
                  </linearGradient>
          ...
          <div className="desktop:text-start desktop:flex desktop:flex-col desktop:mb-0 desktop:translate-x-[220px] desktop:translate-y-[-18px] tablet:mb-[72px] tablet:translate-x-[] tablet:translate-y-[28px] tablet:flex tablet:flex-row flex text-center flex-col gap-[19px] mb-[119px]">
            <Link to="/">
              <h1 className="hover:opacity-[30%] cursor-pointer text-white font-[700] leading-[15.62px] tracking-[2px] text-[12px]">
                Home
              </h1>
            </Link>
            <Link to="/Stories">
        ...
        <div>
          <div className="tablet:translate-x-[136px] tablet:translate-y-[-44px] mb-[34px] cursor-pointer flex flex-wrap max-w-[174px] group">
          ...
          <h1 className="tablet:translate-y-[44px] opacity-[50.25%] max-w-[311px] text-center text-[15px] leading-[19.53px] tracking-[2px] text-white font-[400]">
